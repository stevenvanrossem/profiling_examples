...
locust -f locustfile6.py --host http://10.20.0.2:8888 --no-web -c $1 -r 100 CDNUser&
locust -f locustfile7.py --host http://10.20.0.2:8888 --no-web -c $1 -r 100 CDNUser&
locust -f locustfile8.py --host http://10.20.0.2:8888 --no-web -c $1 -r 100 CDNUser&
locust -f locustfile9.py --host http://10.20.0.2:8888 --no-web -c $1 -r 100 CDNUser&
locust -f locustfile10.py --host http://10.20.0.2:8888 --no-web -c $1 -r 100 CDNUser
